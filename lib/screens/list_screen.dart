import 'package:GLDG/components/bottom_button.dart';
import 'package:GLDG/classes/patient.dart';

import '../classes/mytile.dart';
...
class TileApp extends StatelessWidget {
  ...
  TileApp({@required this.newPatient});

  @override
  Widget build(BuildContext context) {
    List<MyTile> tempList = newPatient.converter();
    return new Scaffold(
      appBar: new AppBar(
        title: new Center(
